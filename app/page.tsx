      ...
      <header className="global-nav">
        <div className="nav-inner">
          ...
          <nav aria-label="주요 메뉴">
            <a className="micro-action" href="#projects" onClick={handleInternalLink} data-cursor="interactive">프로젝트</a>
            <a className="micro-action" href="#about" onClick={handleInternalLink} data-cursor="interactive">소개</a>
            <a className="micro-action" href="#journey" onClick={handleInternalLink} data-cursor="interactive">경험</a>
            <a className="micro-action" href="#contact" onClick={handleInternalLink} data-cursor="interactive">연락</a>
          </nav>
        </div>
      </header>
